...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    LabelNotFoundItem:PropTypes.string,
 ...
 _getSelectLabel = () => {
    const { selectText, single, selectedItems, displayKey,selectIndicatorText } = this.props;
    ...
    if (renderItems.length) {
      ...
      itemList = (
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          >
           {LabelNotFoundItem!==null || LabelNotFoundItem!==''? LabelNotFoundItem: No item to display.} 
          </Text>
        </View>
      );
    }
